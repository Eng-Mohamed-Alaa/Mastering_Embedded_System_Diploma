...
typedef struct
{
	...
	uint8_t 				Trigger_Case;		//specifies the trigger type rising, or falling or both
												//this parameter must be set based on @ref EXTI_Trigger_Define

	uint8_t					IRQ_EN;				//specifies the interrupt is enabled or disabled (to enable the interrupt the IRQ mask is enabled in the EXTI and the NVIC)
...
}EXTI_Pin_Configuration_t;


//----------------------------------------------------------------
//Reference Configurations macros	>>>>	are used to set Reference macros
//----------------------------------------------------------------
...
//----------------------------------------------------------------
//Reference macros		>>>>	are used to set the parameters of EXTI_driver APIs
//----------------------------------------------------------------
