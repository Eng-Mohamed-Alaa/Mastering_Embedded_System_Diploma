...
Src/lab4.o: ../Src/lab4.c
	arm-none-eabi-gcc "$<" -mcpu=cortex-m3 -std=gnu11 -g3 -DSTM32 -DSTM32F1 -DSTM32F103C6Tx -DDEBUG -c -I../Inc -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -MMD -MP -MF"Src/lab4.d" -MT"$@" --specs=nano.specs -mfloat-abi=soft -mthumb -o "$@"
